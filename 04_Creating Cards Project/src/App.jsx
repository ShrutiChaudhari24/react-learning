...
const App = () => {
  ...
  // ye chatgpt sae lae lo prompt doo make a array of 10 objects of job openings, I wnat properties 
  // brandLogo, companyName, datePosted (like 5 days ago, 10 weeks ago), post, tag1 (like part time or full time), tag2 (like junior level or senior level), pay (in dollars per hour), location(mumbai,india)
  // make sure that these compinies are maang or faang or some big tech giants
  ...
  // const arr = [10,20,30,40]; abb ye tho noramal array tha ager humey array of objects banana ho tho bhi hum bana sakte hai
  // const arr= [
  //   {
  //     user: 'Ram',
  //     age: 20
  ...
  return (
    <div className='parent'>      
      ...
      {/* ease bar bar kon likega data  */}
      {/* <User name ='Shruti'/>
      <User name ='Shree'/>
      <User name ='Shrutiiii'/> */}

      {/* array kae through pass karna ho tho ease kar sakte hai per yar itne bar kon likhega */}
      {/* <User name ={arr[0]}/>
      <User name ={arr[1]}/>
      <User name ={arr[2]}/> */}

      {/* tho hum yaha array ki ek menthod use karte hai vo hai array ki map method  */}
      {/* The map() method in JavaScript is used to create a new array by applying a function to every element of an existing array. */}
